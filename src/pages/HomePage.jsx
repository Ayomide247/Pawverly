    ...
    <main className="w-screen h-screen overflow-x-hidden">
      ...
      <div className="mt-[77px]">
        ...
        <section className="flex flex-col-reverse items-center justify-between px-5 py-12 lg:flex-row md:px-10 lg:px-20 bg-secondary">
          ...
          <div className="flex justify-center w-full py-5 lg:justify-end lg:w-auto lg:py-0">
            <img
              src={images[12]}
              alt="Pet Sweaters"
        ...
        <section className="py-20 bg-[#ffffff] lg:px-20 px-2">
          ...
          <div className="flex flex-col items-center justify-center gap-5 py-10 lg:px-5 lg:flex-row sm:px-5 lg:gap-0">
            ...
            <div className="text-[#ffffff] bg-primary py-10 sm:py-[80px] px-5 sm:px-8 md:px-10  lg:rounded-r-[15px]">
        ...
        <section className="py-10 sm:py-20 bg-[#ffffff]">
          <div className="flex flex-col items-center justify-center gap-0 px-5 py-5 lg:flex-row sm:px-20 md:px-56 sm:py-10">
            <div className="text-[#ffffff] bg-primary p-5 sm:py-10 sm:px-8 md:py-[114px] md:px-10 rounded-t-[15px] lg:rounded-l-[15px] lg:rounded-tr-none flex flex-col items-start">
